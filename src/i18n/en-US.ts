...
export const enUS: TranslationKey = {
  ...
  config: {
    ...
    exportConfigsTooltip: 'Export as standard mcp.json (compatible with Cursor, Claude, etc.)',
    importConfigsTooltip: 'Import mcp.json (filters local stdio servers, imports remote only)',
    mcpConfigIO: {
      importPreview: 'Import Preview',
      confirmImport: 'Confirm Import',
      remoteServersToImport: '{count} remote server(s) to import',
      detectedSource: 'Detected config source: {source}',
      importedMultiple: 'Successfully imported {count} configuration(s)',
      skippedCount: 'Skipped {count} unsupported configuration(s)',
      stdioSkipped: 'No importable remote server found, {count} local stdio server(s) skipped',
      sources: {
        native: 'Standard mcp.json',
        legacy: 'Legacy App Format',
        cursor: 'Cursor MCP',
      ...
      skipReasons: {
        stdio: 'Local stdio process mode (filtered)',
        oauth: 'OAuth authentication not supported',
        invalid: 'Invalid configuration format',
        no_url: 'No remote server URL configured',
      },
    },
  ...
  resultDisplay: {
    settingsTitle: 'Result display settings',
    presets: 'Presets',
    presetLabels: {
      auto: 'Auto adapt',
      allContentText: 'All text blocks',
      textByType: 'Filter type=text',
      allParsed: 'All parsed blocks',
      firstText: 'First text block',
      printEachText: 'Print each text',
      commandOutput: 'Command fields sample',
    },
    templateHint: 'Generic syntax: {{auto}}; {{content[*].text}} wildcard; {{content[?type=text].text}} filter; {{parsed[*]}} / {{parsed.0.field}}; print(path). Click path tags below to insert.',
    pathHints: 'Paths for this result',
    preview: 'Preview',
    previewEmpty: '(empty)',
    showRaw: 'Show raw response',
    showPretty: 'Show formatted result',
    autoParseJson: 'Auto-parse JSON in text blocks',
    saveTemplate: 'Save template',
    resetTemplate: 'Reset to default',
    templateSaved: 'Display template saved',
    copied: 'Copied to clipboard',
    prettyTitle: 'Formatted',
    rawTitle: 'Raw response',
    copyPretty: 'Copy formatted',
    copyRaw: 'Copy raw',
    expandPretty: 'Expand panel height',
    collapsePretty: 'Collapse panel height',
  },
